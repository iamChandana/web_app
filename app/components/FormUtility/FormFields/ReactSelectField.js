...
class ReactSelectField extends React.PureComponent {
  constructor(props) {
    super(props);
    this.handleChange = this.handleChange.bind(this);
  }

  handleChange(inputFieldValue) {
    const { input: { onChange } } = this.props;
    onChange(inputFieldValue);
    if (Object.hasOwnProperty.call(this.props, 'handleChange')) {
      this.props.handleChange(inputFieldValue);
    } else if (Object.hasOwnProperty.call(this.props, 'handleChangeIdType')) {
      this.props.handleChangeIdType(inputFieldValue);
    }
  }
