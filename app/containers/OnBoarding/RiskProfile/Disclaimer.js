        ...
        <RowGridCenter>
          ...
          <Grid item>
            <StyledText size="12px" color="#000000" lineHeight="1.67" opacity="1" weight="bold" align="left">
              ...
              &nbsp;of Principal Asset Management Berhad (<Text fontStyle="italic" display="inline" size="12px">formerly known as CIMB-Principal Asset Management Berhad</Text>) and I accept and bear the risk of risk profile I have selected.
            </StyledText>
          </Grid>
        </RowGridCenter>
      </Container>
