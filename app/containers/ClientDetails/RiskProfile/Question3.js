...
import { saveRiskProfile3 } from 'containers/OnBoarding/actions';
...
class Question3 extends React.PureComponent {
  ...
  select(data) {
    ...
    this.props.history.push('/retake/risk-profile/question4');
  }
  render() {
    ...
    if (questions) {
      ...
      return (
        <ColumnGridCenter>
          ...
          <Grid item xs={12}>
            <LastText>
              <Button primary onClick={() => this.props.history.push('/retake/risk-profile/question2')}>
                Back
              </Button>
            </LastText>
          </Grid>
