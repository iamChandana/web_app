...
import { setSelectedVerificationOption } from '../../actions';
...
class RedeemVerificationConfirmationModal extends React.PureComponent {
  constructor() {
    super();
    this.state = {
  ...
  handleChangeVerificationOption(e) {
    const { handleSetSelectedVerificationOption } = this.props;
    handleSetSelectedVerificationOption(e.target.value);
  ...
  handleSubmit() {
    const { handleRedeemFund } = this.props;
...
RedeemVerificationConfirmationModal.propTypes = {
  fullName: PropTypes.string.isRequired,
  email: PropTypes.string.isRequired,
  phoneNumber: PropTypes.string.isRequired,
  open: PropTypes.bool.isRequired,
  handleClose: PropTypes.func.isRequired,
  handleRedeemFund: PropTypes.func.isRequired,
  handleSetSelectedVerificationOption: PropTypes.func.isRequired,
...
const mapDispatchToProps = (dispatch) => ({
  handleSetSelectedVerificationOption: (selectedOption) => dispatch(setSelectedVerificationOption(selectedOption)),
});
...
export default withConnect(RedeemVerificationConfirmationModal);
