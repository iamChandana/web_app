...
class SwitchVerificationConfirmationModal extends React.PureComponent {
  constructor() {
    super();
    this.state = {
  ...
  handleSubmit() {
    const { handleSwitchFund } = this.props;
    const { selectedVerificationOption } = this.state;

    handleSwitchFund(selectedVerificationOption);
  }
...
SwitchVerificationConfirmationModal.propTypes = {
  fullName: PropTypes.string.isRequired,
  email: PropTypes.string.isRequired,
  phoneNumber: PropTypes.string.isRequired,
  open: PropTypes.bool.isRequired,
  handleClose: PropTypes.func.isRequired,
  handleSwitchFund: PropTypes.func.isRequired,
...
export default withConnect(SwitchVerificationConfirmationModal);
