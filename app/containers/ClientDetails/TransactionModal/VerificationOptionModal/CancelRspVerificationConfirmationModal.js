...
class CancelRspVerificationConfirmationModal extends React.PureComponent {
  constructor() {
    super();
    this.state = {
  ...
  handleSubmit() {
    const { handleCancelRsp } = this.props;
...
CancelRspVerificationConfirmationModal.propTypes = {
  fullName: PropTypes.string.isRequired,
  email: PropTypes.string.isRequired,
  phoneNumber: PropTypes.string.isRequired,
  open: PropTypes.bool.isRequired,
  handleClose: PropTypes.func.isRequired,
  handleCancelRsp: PropTypes.func.isRequired,
...
export default withConnect(CancelRspVerificationConfirmationModal);
