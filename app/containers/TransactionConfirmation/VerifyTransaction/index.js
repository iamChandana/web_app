...
export class VerifyTransaction extends React.PureComponent {
  componentDidMount() {
    const {
      history,
      location: { search },
    ...
    handleVerifyTransactionRequest({ token, qStrMsgFromEmail }, isRsp);
  }
...
const mapDispatchToProps = (dispatch) => ({
  handleVerifyTransactionRequest: (payload, isRsp) => dispatch(verifyTransactionRequest(payload, isRsp)),
});
